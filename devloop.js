...
let server = runServer({
  httpPort,
  sh: `java -jar -Dlog.service.output=service.log -Dlog.access.output=access.log target/scala-2.11/qwebmon-assembly-0.1.0.jar -http.port=:${httpPort} -admin.port=:9990`
