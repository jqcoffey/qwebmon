...
let server = runServer({
  name: 'server',
  httpPort,
  sh: `java -cp "target/scala-2.11/qwebmon-assembly-0.1.0-deps.jar${platform == 'win32' ? ';': ':'}target/scala-2.11/classes" com.criteo.qwebmon.FinatraServerMain -http.port=:${httpPort} -admin.port=:9990`
